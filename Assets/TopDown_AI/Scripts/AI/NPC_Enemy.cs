...
public class NPC_Enemy : MonoBehaviour
{
    ...
    void AttackAction()
    {
        switch (weaponType)
        {
            ...
            case NPC_WeaponType.RIFLE:
                GameObject bullet =
                    GameObject.Instantiate(proyectilePrefab, weaponPivot.position, weaponPivot.rotation) as GameObject;
            ...
            case NPC_WeaponType.SHOTGUN:
                ...
                {
                    GameObject birdshot =
                        GameObject.Instantiate(proyectilePrefab, weaponPivot.position, weaponPivot.rotation) as
                            GameObject;
