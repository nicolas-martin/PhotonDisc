...
public class GameManager : MonoBehaviour
{
    ...
    public static void AddScore(int pointsAdded)
    {
        ...
        iTween.ScaleTo(myslf.scoreText.gameObject,
            iTween.Hash("scale", Vector3.one, "time", 0.25f, "delay", 0.1f, "easetype", iTween.EaseType.spring));
    }
    ...
    public static void RegisterPlayerDeath()
    {
        ...
        iTween.ScaleTo(myslf.restartMessage,
            iTween.Hash("scale", Vector3.one, "time", 0.5f, "delay", 0.1f, "easetype", iTween.EaseType.spring));
        myslf.gameOver = true;
    }
